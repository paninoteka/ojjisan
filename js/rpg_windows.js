...
Window_Status.prototype.drawBlock1 = function(y) {
    ...
    //this.drawActorNickname(this._actor, 177, 82);
};

Window_Status.prototype.drawBlock2 = function(y) {
    this.drawActorFace(this._actor, 32, 120);
    this.drawExpInfo(225, y);
};

Window_Status.prototype.drawBlock3 = function(y) {
    this.drawBasicInfo(48, y);
    this.drawParameters(48, 478);
    this.drawEquipments(320, 605);
};
...
Window_Status.prototype.drawProfile = function(x, y) {
    this.drawTextEx(this._actor.profile(), x, 780);
};
